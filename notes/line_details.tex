...
\begin{align}
 ...
 A(\text{CMS1709c2}) &=
  \frac{p\w hp_\ell^2}{2} p(\tilde\tau^{(*)}|\charPM[1])p(\tilde\tau^{(*)}|\neut[2])
+ {p\w h} p(\tilde\tau^{(*)}|\charPM[1])p(\tilde\ell^{(*)}|\neut[2])
+ \frac{p\w hp_\ell}{2} p(\tilde\ell^{(*)}|\charPM[1])p(\tilde\tau^{(*)}|\neut[2]),
\notag\\&\qquad\qquad\vev{0.445}\\
